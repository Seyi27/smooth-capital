  ...
  return (
    <div>
          ...
          <div className="w-full flex flex-col justify-self-center">
            <div className="flex flex-col sm:flex-row sm:items-center justify-center gap-10">
              ...
              <div className="flex-1">
                <p className="text-[20px] text-custom-grey pb-10">
      ...
      <AppWrapper wrapperbgcolor="bg-custom-white" className="py-15">
        <div className="text-center">
          <p className="text-[50px] ">
            ...
            <span className="text-custom-blue font-bold">Investment</span>{" "}
      ...
      <AppWrapper wrapperbgcolor="bg-custom-white" className="py-15">
        <div className="text-center">
          <p className="text-[50px]">
            <span>Why Choose</span> <span className="text-custom-blue font-bold">Smooth Capital</span>
          </p>
        </div>
