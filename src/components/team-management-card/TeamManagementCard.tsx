    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col">
          <p className="text-[16px] sm:text-[18px] text-black font-bold">{item.name}</p>
          <p className="text-custom-grey text-[13px] sm:text-[14px]">{item.position}</p>

          <span className="text-custom-grey py-2 text-[13px] sm:text-[14px] mb-5">
            {item.short_description}
          </span>

          <p className="flex items-center gap-2 text-custom-blue text-[13px] sm:text-[14px] font-medium">
