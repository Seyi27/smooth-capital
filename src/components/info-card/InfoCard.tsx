...
const InfoCard = ({ item, setIsOpenModal }: InfoCardProps) => {
  return (
    <div className="relative p-5 bg-custom-blue text-white rounded-[30px] shadow-lg rotate -rotate-10">
      <p className="text-[12px] sm:text-[14px] leading-relaxed">{item.short_description}</p>

      {/* Button */}
      <button
        className="text-[12px] sm:text-[14px] mt-5 inline-block rounded-full bg-[#00E5FF] text-custom-blue font-medium px-3 py-1 text-sm hover:opacity-90 transition cursor-pointer"
